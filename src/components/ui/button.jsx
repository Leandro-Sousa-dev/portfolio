...
export const ButtonFB = (props) => {

    const myThemeColors = {
        "color": {
            "darkIndigo": "border border-transparent bg-indigo-800 text-white focus:ring-4 focus:ring-indigo-400 enabled:hover:bg-indigo-900 dark:bg-indigo-700 dark:hover:bg-indigo-800 dark:focus:ring-indigo-900",
            "darkBlue": "border border-transparent bg-blue-800 text-white focus:ring-4 focus:ring-blue-400 enabled:hover:bg-blue-900 dark:bg-blue-700 dark:hover:bg-blue-800 dark:focus:ring-blue-900",
            ...
            "red": "border border-transparent bg-red-800 text-white focus:ring-4 focus:ring-red-400 enabled:hover:bg-red-900 dark:bg-red-700 dark:hover:bg-red-800 dark:focus:ring-red-900",
    ...
    return (
        <div className="flex flex-wrap gap-2">
            <Button theme={myThemeColors} className="w-40" color={props.color} as='a' href={props.href} target='_blank'>
                {props.children}
            </Button>
        </div>
    );
